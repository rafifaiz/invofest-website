...
import { Users, Plus, User, Share2, MessageCircle } from 'lucide-react';
  ...
  return (
    <div className="p-8">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-8 gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Pembicara</h1>
          <p className="text-lg text-gray-600">Kelola daftar pembicara terhormat Invofest</p>
        </div>
        <Link
      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-xl font-bold text-gray-900">Daftar Pembicara</h2>
        </div>
        <div className="divide-y divide-gray-200">
          {speakers.length === 0 ? (
            <div className="text-center py-16">
              <Users className="mx-auto h-16 w-16 text-gray-400 mb-4" />
              <h3 className="text-lg font-medium text-gray-900 mb-2">Belum ada pembicara</h3>
              <p className="text-gray-500 mb-6">Tambahkan pembicara pertama untuk event</p>
              <Link
                to="/dashboard/pembicara/create"
            ...
            speakers.map((speaker) => (
              <div key={speaker.id} className="p-6 hover:bg-gray-50 transition-colors">
                <div className="flex items-center gap-6">
                  <div className="w-16 h-16 bg-gradient-to-r from-rose-400 to-pink-500 rounded-2xl flex items-center justify-center shadow-lg">
                  ...
                  <div className="text-right">
                    <p className="text-sm font-semibold text-gray-900">{speaker.events} Event</p>
